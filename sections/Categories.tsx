  ...
  return (
    <section className='my-20 max-w-8xl mx-auto'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-7xl mx-auto place-items-center'>
            <CategoryCard delay={2000} header={{en: cake[0].category.en, ar: cake[0].category.ar}} link='/collections/menu' data={cake.slice(0,6)} />
            <CategoryCard delay={2000} header={{en: cupcake[0].category.en, ar: cupcake[0].category.ar}} link='/collections/menu' data={cupcake.slice(0,6)} />
            <CategoryCard delay={2100} header={{en: dates[0].category.en, ar: dates[0].category.ar}} link='/collections/menu' data={dates.slice(0,6)} />
            <CategoryCard delay={2100} header={{en: cookies[0].category.en, ar: cookies[0].category.ar}} link='/collections/menu' data={cookies.slice(0,6)} />
        </div>
    </section>
  )
}
